...
namespace AnimatorExtension.Parameters
{
    public class EventInfoContainer
    {
        ...
        public EAnimationEventParameter[] paramTypes { get; private set; }

        public Type[] customParamTypes { get; private set; }

        public int[] eventNameHashes { get; private set; }
        ...
        public void Build()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                this.customParamTypes[i] = _customParams[i];
                this.eventNameHashes[i] = Extension.StringToHash(this._eventNames[i]);
                
                _customParamTypes.Add(this.eventNameHashes[i], this.customParamTypes[i]);
            }
        }
    }
}